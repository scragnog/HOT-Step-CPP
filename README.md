...
>
> **Licence:** YuE2's weights are **CC BY-NC 4.0**, unlike the other two backends — but the upstream authors have [clarified](https://huggingface.co/m-a-p/YuE2-3B/discussions) that individual creators, musicians and researchers may use the model and its outputs freely, **including commercially**. Only companies need to buy a commercial licence; contact the authors at gezhang@umich.edu. The picker and Model Manager carry the same notice.
