        ...
        <div className="mt-4 flex flex-col gap-4">
          ...
          <div className="rounded-lg border border-zinc-300/60 dark:border-white/5 p-3">
            ...
            <div className="mt-2 flex flex-wrap items-end gap-x-6 gap-y-3">
              ...
              <label className="flex flex-col gap-1 w-32">
                <ParamLabel label={t('trainingStudio.refine.narLrScale', 'Decoder rate (× run)')} meta={t('trainingStudio.refine.narLrMeta', '0.05–1 · default 1')} info={t('trainingStudio.refine.narLrInfo', 'Fraction of the source run\'s rate for the decoder pass. The planner is frozen here, so the refinement\'s slow pacing (its rate box above, plus the halving on skipped rungs) does not apply: the decoder trains at the rate the main run used. Lower it if the reconstruction meter gets worse instead of better.')} />
