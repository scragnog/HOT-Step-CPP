...
export const useGlobalParamsStore = create<any>()((set, get) => ({
  ...
  mergeHqIncludeCond: readKey("hs-mergeHqIncludeCond", false),
  mergeHqIncludeTime: readKey("hs-mergeHqIncludeTime", false),
  ...
  setMergeHqIncludeCond: (v: any) => { set({ mergeHqIncludeCond: v }); writeKey("hs-mergeHqIncludeCond", v); },
  setMergeHqIncludeTime: (v: any) => { set({ mergeHqIncludeTime: v }); writeKey("hs-mergeHqIncludeTime", v); },
  ...
  getGlobalParams: (): Partial<GenerationParams> => {
    ...
    return {
      ...
      mergeHqIncludeCond: (s.adapter && s.adapterMode === 'merge_hq') ? s.mergeHqIncludeCond : undefined,
      mergeHqIncludeTime: (s.adapter && s.adapterMode === 'merge_hq') ? s.mergeHqIncludeTime : undefined,
