...
| Phase tabs (Dataset · Preprocess/Codes · Train · Refine · Review · Monitor) | Switches between the stages above. Preprocess/Codes and Monitor are hidden under YuE2; Refine and Review only appear under YuE2. With a dataset open, **All datasets** at the left of the tabs goes straight back to the grid. |
